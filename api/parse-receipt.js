...
1. 提取商品原文名稱（日文）
2. 將商品名稱翻譯成繁體中文。務必使用「最簡潔、最基本、最通用」的品名，去掉品牌名、行銷用詞、修飾詞，只保留核心品項名稱，這樣同一種商品每次翻譯才會一致。例如「風雅卵」「まごころ卵」都應翻成「雞蛋」（不要翻成「土雞蛋」「有機蛋」等細節詞，除非收據品名明確標示特殊品種如「烏骨雞蛋」）；「あじわいオレンジ」翻成「橙子」；「明治おいしい牛乳」翻成「牛奶」。
3. 提取價格
